        ...
        <div className="flex flex-col gap-6 md:gap-8 max-w-xl">
          ...
          <div className="flex items-center gap-4 mt-2">
            <button
              ...
              className="px-8 py-3.5 rounded-xl bg-foreground text-background font-semibold text-[15px] hover:opacity-90 transition-all hover:scale-[1.02] flex items-center justify-center border border-transparent shadow-sm cursor-pointer"
            >
              Get Started
            </button>
            <button
              onClick={onExplore}
              className="px-6 py-3.5 rounded-xl bg-background/50 border border-border text-foreground font-semibold text-[15px] hover:bg-secondary transition-all hover:scale-[1.02] flex items-center justify-center backdrop-blur-sm cursor-pointer"
            >
              Explore platform
            </button>
          </div>
