    ...
    <nav className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-12 py-4 bg-background/60 backdrop-blur-md border-b border-subtle">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="p-2 rounded-lg hover:bg-secondary transition-colors text-muted-foreground hover:text-foreground focus:outline-none"
        ...
        <button
          onClick={onSignIn}
          className="flex items-center px-4 py-2 text-[13px] font-semibold bg-secondary/70 text-foreground border border-border rounded-lg hover:bg-secondary/90 transition-all hover:scale-[1.01]"
        >
